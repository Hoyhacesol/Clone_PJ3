    ...
    <>
          ...
          {!user ? (
            ...
            <div className={styles.user_dropdown}>
              ...
              <div className={`${styles.user_dropdown_box} ${dropdownOpen ? styles.open : ""}`}>
                <img className={styles.profile_img_dropdown} src={`/images/${user.profileimg || "baseprofile.png"}`} alt="프로필 사진" />
                <p>
                  안녕하세요! <br />
      ...
      <div className={`${styles.sidebar} ${isSidebarOpen ? styles.show : ""}`}>
        <div className={styles.sidebar_userbox}>
          {!user ? (
            <>
              <img className={styles.profile_img} src={`/images/baseprofile.png`} alt="비로그인 프로필 사진" />
              <p>비로그인 상태입니다.</p>
              <div className={styles.sidebar_buttons}>
            ...
            <>
              <img className={styles.profile_img} src={`/images/${user.profileimg || "baseprofile.png"}`} alt="프로필 사진" />
              <p>
                안녕하세요! <br />
                <strong>{user.nickname}</strong> 님
              </p>
