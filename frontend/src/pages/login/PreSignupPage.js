...
function PreSignupPage() {
  ...
  const preNext = async (e) => {
    ...
    try {
      const res = await axios.get(`http://43.201.249.236:8080/api/members/email_check`, {
        params: { email: email },
      });
  ...
  const handleGoogleSignup = () => {
    window.location.href = "http://43.201.249.236:8080/oauth2/authorization/google";
  };

  // 주석: 카카오 회원가입
  const handleKakaoSignup = () => {
    window.location.href = "http://43.201.249.236:8080/oauth2/authorization/kakao";
  };
  return (
